...
public class ZtTagAdapter2<T> extends BaseAdapter {

    private final Context mContext;
    private final List<T> mDataList;
    private int typeFlag;
    public ZtTagAdapter2(Context context,int typeFlag) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.activity_sp_sx_item2, null);
