...
public class WriteYbActivity extends BaseSwipeBackActivity implements WriteRzContract.view{
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_write_yb;
    }
        ...
        tagAdapter.setOnItemClickListener(new TagAdapter.OnItemClickListener() {
            ...
            public void onAddItemClicked(int position,List<Node> mDataList) {
                if(position == mDataList.size()-1) {
                    Intent intent = new Intent(WriteYbActivity.this, SelectPeopleActivity.class);
    ...
    public void onSubmit(){
        String bzgzcontent = wcgzEt.getText().toString();//工作内容
        String gzzjcontent = wgzTv.getText().toString();//工作总结
        String plan = nextzjEt.getText().toString();//工作计划
        String xietiao = xietiaoEt.getText().toString();//协调
        String remark = beizhuEt.getText().toString();//备注
        if(TextUtils.isEmpty(bzgzcontent)){
            CommonUtil.showToast(this,"本周工作内容不能为空");
            return;
        }
        ...
        writeRzPresenter.onSubmit(listId,bzgzcontent,gzzjcontent,plan,xietiao,remark,2,mSelectPath);
    }
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(WriteYbActivity.this, new String[]{permission}, requestCode);
                        }
                    })
                ...
                imageItemAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
                    ...
                    public void onItemClick(View view, int i) {
                       ...
                       /* mSelectPath.remove(i);
                        imageItemAdapter.setNewData(mSelectPath);*/
                        Intent intent = new Intent(WriteYbActivity.this, ImagePagerActivity.class);
                        // 图片url,为了演示这里使用常量，一般从数据库中或网络中获取
                        intent.putExtra(ImagePagerActivity.EXTRA_IMAGE_URLS, mSelectPath);
                        intent.putExtra(ImagePagerActivity.EXTRA_IMAGE_INDEX,i);
                        WriteYbActivity.this.startActivity(intent);
                    }
                });
            }
        }
