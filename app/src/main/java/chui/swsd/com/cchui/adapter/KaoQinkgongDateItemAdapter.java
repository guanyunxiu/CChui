...
public class KaoQinkgongDateItemAdapter extends BaseQuickAdapter<KaoQinListBean.WorkdateBean> {
    public KaoQinkgongDateItemAdapter(MyKaoQinActivity myKaoQinActivity, List<KaoQinListBean.WorkdateBean> list) {
