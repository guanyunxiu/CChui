...
public class WriteZbActivity extends BaseSwipeBackActivity implements WriteRzContract.view{
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_write_zb;
    }
        ...
        tagAdapter.setOnItemClickListener(new TagAdapter.OnItemClickListener() {
            ...
            public void onAddItemClicked(int position,List<Node> mDataList) {
                if(position == mDataList.size()-1) {
                    Intent intent = new Intent(WriteZbActivity.this, SelectPeopleActivity.class);
    ...
    public void onSubmit(){
        String finish = wcgzEt.getText().toString();
        String zjie = wgzTv.getText().toString();
        String plan = planEt.getText().toString();
        String xietiao = xietiaoEt.getText().toString();
        String remark = beizhuEt.getText().toString();
        if(TextUtils.isEmpty(finish)){
            CommonUtil.showToast(this,"本周完成工作不能为空");
            return;
        }
        ...
        writeRzPresenter.onSubmit(listId,finish,zjie,plan,xietiao,remark,1,mSelectPath);
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.mis_permission_dialog_ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(WriteZbActivity.this, new String[]{permission}, requestCode);
                        }
                    })
                ...
                imageItemAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
                    ...
                    public void onItemClick(View view, int i) {
                       ...
                       /* mSelectPath.remove(i);
                        imageItemAdapter.setNewData(mSelectPath);*/
                        Intent intent = new Intent(WriteZbActivity.this, ImagePagerActivity.class);
                        // 图片url,为了演示这里使用常量，一般从数据库中或网络中获取
                        intent.putExtra(ImagePagerActivity.EXTRA_IMAGE_URLS, mSelectPath);
                        intent.putExtra(ImagePagerActivity.EXTRA_IMAGE_INDEX,i);
                        WriteZbActivity.this.startActivity(intent);
                    }
                });
            }
        }
