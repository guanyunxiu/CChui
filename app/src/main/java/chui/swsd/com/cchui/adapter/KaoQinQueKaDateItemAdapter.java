...
public class KaoQinQueKaDateItemAdapter extends BaseQuickAdapter<KaoQinListBean.WorkdateBean> {
    public KaoQinQueKaDateItemAdapter(MyKaoQinActivity myKaoQinActivity, List<KaoQinListBean.WorkdateBean> list) {
