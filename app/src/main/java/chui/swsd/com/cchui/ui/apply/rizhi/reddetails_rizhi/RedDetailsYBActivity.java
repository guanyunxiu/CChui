...
public class RedDetailsYBActivity extends BaseSwipeBackActivity implements RedDetailsContract.view{
    ...
    protected int attachLayoutRes() {
        return R.layout.activity_yb_details;
    }
    ...
    public void setAdater(){
        ...
        imageItemAdapter.setOnRecyclerViewItemClickListener(new BaseQuickAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(View view, int i) {
                ...
                Intent intent = new Intent(RedDetailsYBActivity.this, ImagePagerActivity.class);
    ...
    public void initData(RzDetailsBean rzDetailsBean) {
        ...
        workTv3.setText(rzDetailsBean.getPlan());
        workTv4.setText(rzDetailsBean.getCoordinate());
        workTv5.setText(rzDetailsBean.getRemark());
