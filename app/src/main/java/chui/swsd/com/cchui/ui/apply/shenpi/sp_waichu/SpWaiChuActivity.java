...
public class SpWaiChuActivity extends BaseSwipeBackActivity implements SpWaiChuContract.view{
    ...
    SpWaiChuPresenter spWaiChuPresenter;
    MProgressDialog mMProgressDialog;
    @Override
    protected int attachLayoutRes() {
        return R.layout.activity_sp_waichu;
    }

    @Override
    protected void initViews() {
        initTitle(true, "外出");
        spWaiChuPresenter = new SpWaiChuPresenter(this,this);
        ...
        tagAdapter.setOnItemClickListener(new SpTagAdapter.OnItemClickListener() {
            ...
            public void onAddItemClicked(int position,List<String> mDataList) {
                if(position == mDataList.size()-1) {
                    Intent intent = new Intent(SpWaiChuActivity.this,ContractsActivity.class);
    ...
    public void submit(){
        ...
        if(TextUtils.isEmpty(numsTv.getText().toString())){
            CommonUtil.showToast(this,"请输入外出时间");
            return;
        }
        if(TextUtils.isEmpty(reasonTv.getText().toString())){
            CommonUtil.showToast(this,"请输入外出事由");
            return;
        }
        if(list.size() == 1){
        ...
        spWaiChuPresenter.onSubmit(startTv.getText().toString(),endTv.getText().toString(),numsTv.getText().toString(),reasonTv.getText().toString(),listUser);
    }
