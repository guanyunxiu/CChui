...
public class KaoQinEarlyDateItemAdapter extends BaseQuickAdapter<KaoQinListBean.WorkdateBean> {
    public KaoQinEarlyDateItemAdapter(MyKaoQinActivity myKaoQinActivity, List<KaoQinListBean.WorkdateBean> list) {
