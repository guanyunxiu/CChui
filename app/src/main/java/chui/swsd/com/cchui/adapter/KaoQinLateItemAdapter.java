...
public class KaoQinLateItemAdapter extends BaseQuickAdapter<KaoQinListBean.WorkdateBean> {
    public KaoQinLateItemAdapter(MyKaoQinActivity myKaoQinActivity, List<KaoQinListBean.WorkdateBean> list) {
